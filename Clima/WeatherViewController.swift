...
class WeatherViewController: UIViewController, CLLocationManagerDelegate, chaneCityDelegate {
    
    //Constants
    let WEATHER_URL = "http://api.openweathermap.org/data/2.5/weather"
    let APP_ID = "3f06b9b8f3b355b84f4062daef51673d"
    ...
    func updateWeatherData(json: JSON){
        ...
        weatherDataModel.temparature = Int(tempResults - 273.15)
